    ...
    <main className="max-w-3xl mx-auto px-6 py-16 font-[Montserrat] text-[var(--foreground)] leading-relaxed">
      ...
      <section className="space-y-6">
        <p>
          ...
          account, place an order, book an event, or contact us.
        </p>
        ...
        <table className="w-full border border-[#ddd] text-sm mt-4">
          ...
          <tbody>
            <tr className="border-t border-[#ddd]">
              <td className="p-3">
                Providing account, order, booking, and customer services
              </td>
        ...
        <p>
          Your personal data is stored securely using encrypted connections
          such as HTTPS and trusted providers such as Supabase, Resend, and
        ...
        <p>
          ...
          marketing emails at any time. We’ll only contact you about news,
          offers, or promotions if you have opted in.
        </p>
