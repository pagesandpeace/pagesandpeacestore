 ...
 if(series){
  ...
  return <main className="min-h-screen bg-background pb-20">
    ...
    <section className="mx-auto max-w-5xl px-6 py-12">
      ...
      <h2 className="text-2xl font-bold">Choose your date</h2>
