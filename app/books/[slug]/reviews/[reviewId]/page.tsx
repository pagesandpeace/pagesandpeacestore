  ...
  return <><Navbar /><main className="min-h-screen bg-[#FAF6F1] px-6 py-12 text-[#17221f]">
    <div className="mx-auto max-w-3xl">
      ...
      <article className="mt-6 overflow-hidden rounded-3xl border bg-white shadow-sm">
        {data.review.image_url ? <div className="relative aspect-[16/9]"><Image src={data.review.image_url} alt="" fill sizes="(max-width: 768px) 100vw, 768px" className="object-cover" /></div> : null}
        <div className="p-6 md:p-9">
          ...
          <div className="mt-6 flex items-center gap-3 border-y py-4">
            {data.review.reviewer.image ? <Image src={data.review.reviewer.image} alt="" width={40} height={40} className="h-10 w-10 rounded-full object-cover" /> : <div className="h-10 w-10 rounded-full bg-[#EDE7DF]" />}
