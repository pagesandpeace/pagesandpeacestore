...
import BackLink from "@/components/BackLink"; // ← Make sure this exists
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-neutral-800 leading-relaxed">
              Cancellations made <strong>48 hours or more before the event</strong> are
              eligible for a <strong>full refund</strong> or a credit voucher for a future event.
            </p>
            ...
            <p className="text-neutral-800 leading-relaxed">
              ...
              <strong> not eligible for a refund</strong>. A credit voucher may be offered at
              our discretion if the space can be resold.
            </p>
