...
export default function EditBlindDatePage({ initial }: { initial: BlindDateProduct }) {
  ...
  const [form, setForm] = useState({
    ...
    metadata: {
      theme: initial.metadata?.theme ?? "",
      colour: initial.metadata?.colour ?? "",
      vibe: initial.metadata?.vibe ?? "",
      items: initial.metadata?.items ?? [],
    } as BlindDateMetadata,
  });
  ...
  function handleAddItem() {
    ...
    setForm((prev) => ({
      ...
      metadata: {
        ...prev.metadata,
        items: [...prev.metadata.items, newItem.trim()],
      },
    }));
  ...
  function handleRemoveItem(idx: number) {
    setForm((prev) => ({
      ...
      metadata: {
        ...prev.metadata,
        items: prev.metadata.items.filter((_, i) => i !== idx),
      },
    }));
  }
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setForm((prev) => ({
                ...prev,
                metadata: { ...prev.metadata, theme: e.target.value },
              }))
            }
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setForm((prev) => ({
                ...prev,
                metadata: { ...prev.metadata, colour: e.target.value },
              }))
            }
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setForm((prev) => ({
                ...prev,
                metadata: { ...prev.metadata, vibe: e.target.value },
              }))
            }
          >
